...
def main():
    ...
    if secim == 'E':
        ...
        ad = input("Adınız: ")
        while True:
            tc = input("TC Kimlik Numaranızı giriniz_11 hane: ")
        ...
        while True:
            kartno = input("Kredi Kartı Numaranız _ 16 hane: ")
            if len(kartno) != 16 or not kartno.isdigit():
                ...
                break
        while True:
            cvv = input("Kredi Kartı CVV Kodunuz _ 3 hane: ")
        ...
        while True:
            kartsifre= input("Kredi Kart Şifreniz _ 4 hane: ")
